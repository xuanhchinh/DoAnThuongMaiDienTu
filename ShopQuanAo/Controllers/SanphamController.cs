...
namespace ShopQuanAo.Controllers
{
    public class SanphamController : Controller
    {
        ...
        //public PartialViewResult CheckView()
        //{
        //    if (Session["id"].Equals(""))
        //    {
        //        ViewBag.name = "";
        //        var list = db.Orders.Where(m => m.status != 0).OrderBy(m => m.status);
        ...
        //        int id1 = ViewBag.id;
        //        var list = db.Orders.Where(m => m.userid == id1 && m.status !=0).OrderBy(m => m.status);
        //        return PartialView(list);
        //    }
        //}
