...
namespace ShopQuanAo.Controllers
{
    public class CheckoutController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            if (Session["id"].Equals("") || Session["SessionCart"] == null)
            {
                ViewBag.name = "";
            ...
            var information = db.users.Where(m => m.ID == s).FirstOrDefault();
            ViewBag.fullname = information.fullname;
            ViewBag.email = information.email;
            ViewBag.sdt = information.phone;
        ...
        public void saveOrder(Morder order,string paymentMethod,int StatusPayment,string ordercode)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ViewBag.Methodpayment = order.deliveryPaymentMethod;
